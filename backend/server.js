...
app.get("/businesses/:business_id/counters/:counter_id", (request, response) => {
...
app.get("/businesses/:business_id/counters/:counter_id/items/:item_id/edit", (request, response) => {
...
app.post("/businesses/:business_id/counters/:counter_id/items/:item_id", (request, response) => {
    ...
    if (db.counters[counter_id]) {
        ...
        if (counter.compartiments[item_id]) {
            ...
            fs.writeFile(__dirname + '/database/db.json', JSON.stringify(db), function (err) {
                if (err) throw err;
